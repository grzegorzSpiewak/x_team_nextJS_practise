...
var Homepage = {
  ...
  CheckList: {
    ...
    items: [{ text: "A full-time, scaleable team of trusted developers." }, { text: "In-depth, daily progress updates (without asking for them). We can also join daily stand-ups." }, { text: "Dedicated account manager, available any time." }, { text: "Flexible contracts with simple monthly billing." }]
  },
  ...
  Quotes: {
    ...
    ctaAnchor: "Past Work",
    ctaTitle: "Portfolio",
    items: [{ quote: "All the X-Teamers who worked on our team brought something unique to the table and helped create a synergy that's almost impossible to find.", company: 'Danielle Chircop, Kaplan Inc.' }]
  },
